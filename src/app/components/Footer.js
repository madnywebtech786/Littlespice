        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4 pr-4">
            ...
            <p className="text-white text-base leading-relaxed">
              ...
              ingredients, and a commitment to consistency.
            </p>
            <div className="flex space-x-3 pt-2">
              {socialLinks.map((link, index) => (
                <Link
                  key={index}
                  href={link.href}
                  className="w-9 h-9 flex items-center justify-center rounded-full border-2 border-gray-700 text-white hover:bg-primary-red hover:border-primary-red transition-all duration-300"
                >
                  {link.icon}
                </Link>
              ))}
