...
const FoodCard = ({ item }) => (
  <div className="py-10 section-shape bg-white hover:bg-primary-red group rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.07)] overflow-hidden text-center group transition-all duration-300 hover:shadow-[0_10px_40px_rgba(0,0,0,0.1)] hover:-translate-y-2">
    ...
    <div className="p-7">
      ...
      <h4 className="text-2xl font-bold text-dark-text mt-3 mb-2">
        <Link
          ...
          className="group-hover:text-white duration-300 transition-colors duration-300"
        >
          {item.title}
        </Link>
      </h4>
